...
namespace ZeroProgress.Common
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "New Anim Param", menuName = ScriptableObjectPaths.ZERO_PROGRESS_PRIMITIVES_PATH + "Scriptable Anim Param", order = (int)ScriptableVariablesMenuIndexing.AnimParam)]
