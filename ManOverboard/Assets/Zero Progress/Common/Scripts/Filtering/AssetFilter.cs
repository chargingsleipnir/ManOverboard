...
namespace ZeroProgress.Common
{
    [CreateAssetMenu(fileName = "New Asset Filter", 
        menuName = ScriptableObjectPaths.ZERO_PROGRESS_FILTERS_PATH + "Asset Filter (Editor-Only)", order = (int)ScriptableFiltersMenuIndexing.AssetFilter)]
    public class AssetFilter : ScriptableObject
    {
...
#else            
            throw new System.InvalidOperationException("Cannot call Find Asset Paths outside of Unity Editor");
#endif
        ...
        public bool ShouldBeIncluded(string assetPath)
        {
